        ...
        <div class="container">
            <div class="payment-wrapper">
                    ...
                    <div class="payment-content">
                        <div class="payment-body">
                            <div class="payment-plan">
                                <div class="payment-plan-type">PLR</div>
                                <div class="payment-plan-info">
                                    <div class="payment-plan-info-name">Private Label Right License</div>
                                    <div class="payment-plan-info-price">Normal Price <s>$59</s></div>
                                </div>
                            ...
                            <div class="payment-summary">
                                <div class="payment-summary-item">
                                    ...
                                    <div class="payment-summary-price"><s>$54</s></div>
                                </div>
                                <div class="payment-summary-item">
                                    <div class="payment-summary-name">Discount 50%</div>
                                    <div class="payment-summary-price">$27</div>
                                </div>
                ...
                <div class="payment-right">
                    <form action="{{ route('transactions.store') }}" method="POST" class="payment-form">
                        @csrf
