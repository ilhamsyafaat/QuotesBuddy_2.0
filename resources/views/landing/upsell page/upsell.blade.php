...
<head>
    ...
    <!-- CSS Custom  -->
    <link rel="stylesheet" href="asset/css/upsell_page.css">
    <link rel="icon" href="asset/image1/LOGO.png">
</head>
...
<body>
                ...
                <div class="card shadow card-custom-section1">
                    <div class="card-body">
                        <div class="text-center">
                            <h2 class="fw-bold mb-4 text-section1">Your Purchase Success!<i
                                    class="fas fa-check-circle ms-2" style="color: #2AD348;"></i></h2>
                            <img src="asset/image1/gambar-1.svg" width="350px" class="mb-4 img-fluid" />
                            <a href="{{ route('landing.download.Download_salespage') }}">
                                <button class="btn btn-custom-section6 text-white fw-bold mb-4 mt-2 pulsating-button" type="button">
                                    <span class="d-flex align-items-center">
                                    <i class="fa-solid fa-cloud-arrow-down me-4"></i>Download Now
                                </span>
                                </button>
                            </a>
                            <h5 class="fw-semibold">Continue your purchase by scrolling down<br> to review the products
                                you've selected.</h5>
                            <a href="#section-2" class="smooth-scroll flex justify-center items-center"><i class="fas fa-arrow-alt-circle-down mt-3"
    ...
    <section id="section-2" class="container-fluid">
        <div class="container">
            <div class="text-center">
                <h2 class="fw-bold mb-5 text-section2" style="font-size: 45px;">Upgrade Your
                    Package for <span style="color: #FDAB0D;">Quotes Buddy 2.0</span> and <br>Receive an Exclusive
                    Commercial License
                    with Additional Content!</h2>
            ...
            <div class="d-flex justify-content-center">
                <img src="asset/image1/Mockup-QuotesBuddy2.0-1.png" class="img-fluid mb-5"
                    style="width: 1000px; height: auto;" />
            </div>
            <div class="container">
                <div class="text-center mx-auto px-5 mb-5 text-section2-2">
                    <h5 class="fw-semibold detail-text-section2-2">Take your social media presence to new heights with
                        this extensive
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col mb-4 mt-4">
                    <div class="card shadow card-custom-section3">
                        <div class="card-body d-flex flex-column justify-content-center align-items-center p-4">
                            ...
                            <h3 class="fw-bold">Total Value = <span style="color: #E62A2A;">$10.125</span></h3>
                        </div>
                    </div>
                ...
                <div class="col mt-4">
                    <div class="card shadow card-custom-section3">
                        <div class="card-body d-flex flex-column justify-content-center align-items-center p-4">
                            <h2 class="fw-bold mb-5 title-column-2 text-white text-center">NEW Platinum Package</h2>
                            <ul class="fa-ul mb-5">
                                <li class="mb-3 fw-semibold" style="font-size: 14px"><span class="fa-li"><i
                                            class="fas fa-check-circle me-3" style="color: #2AD348;"></i></span>25
    ...
    <section id="section-4" class="container-fluid">
        <div class="container">
            <div class="text-center">
                ...
                <img src="asset/image1/questions-animate.svg" class="img-fluid mb-5"
                        ...
                        <div class="d-flex justify-content-center align-items-center" style="height: 100%;">
                            <div class="row justify-content-center align-items-center">
                                <div class="col-md-4 text-center mb-4 mb-md-0">
                                    <img src="asset/image1/social-media-animate.svg" class="img-fluid"
                        ...
                        <div class="d-flex justify-content-center align-items-center" style="height: 100%;">
                            <div class="row justify-content-center align-items-center">
                                <div class="col-md-4 text-center mb-4 order-md-1">
                                    <img src="asset/image1/example-animate.svg" class="img-fluid"
                                        style="width: 300px; height: auto;" />
                                </div>
                ...
                <div class="card shadow card-custom-section4 mb-5" style="width: 1200px;">
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-center align-items-center" style="height: 100%;">
                            <div class="row justify-content-center align-items-center">
                                <div class="col-md-4 text-center mb-4 mb-md-0">
                                    <img src="asset/image1/upload-animate.svg" class="img-fluid"
                                        style="width: 300px; height: auto;" />
                                </div>
                                <div class="col text-center text-md-start desc" style="padding-right: 50px;">
            ...
            <div class="container">
                <div class="text-center">
                    ...
                    <img src="asset/image1/son.png" class="img-fluid" style="max-width: 100%;" />
                </div>
            </div>
    ...
    <section id="section-5" class="container-fluid smooth-scroll flex justify-center items-center">
        <div class="container">
            <div class="d-flex justify-content-center">
            ...
            @foreach($images as $quote)
                ...
                <div class="text-center">
                    ...
                    <h5 class="fw-bold mb-5" style="font-size: 30px;">All Those Templates Also Available In<br><span
                            style="color: #FDAB0D;">Static Version</span></h5>
                </div>
                <div class="mb-4">
                    <div class="text-center">
            ...
            <div class="d-flex justify-content-center">
                <div class="card shadow card-custom-section7">
                    <div class="card-body text-center">
                        ...
                        <img src="asset/image1/discount-animate.svg" class="img-fluid" width="500px" />
                        <h4 class="fw-semibold mb-4 text-section7-1">If You Leave This Page Now,<br>
                            You Will Never Get to See This Offer Again...</h4>
                        <h5 class="mb-5 text-section7-2">Secure Your Special Price for Only <s>$97</s> <s>$67</s>
                            <s>$47</s></h5>
                        <a href="{{ route('landing.downsell page.downsell') }}" class="custom-href">
                            <h5 class="fw-semibold text-rejection text-section7-3" style="font-size: 12px;">No Thanks -
                                I Don't Want Add
                                this Huge
    ...
    <section id="section-8" class="container-fluid">
        <div class="container">
            <div class="text-center">
                <img src="asset/image1/LOGO.png" width="160px" class="img-fluid mb-4" /><br>
                <h7 class="fw-regular text-section8-1" style="font-size: 10px">ALL TRADEMARKS AND LOGOS ARE THE PROPERTY
                    OF THEIR
                ...
                <h7 class="fw-regular text-section8-2" style="font-size: 10px;">Disclaimer: <i>WarriorPlus is used to
                        help manage the
