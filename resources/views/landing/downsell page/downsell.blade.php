...
<head>
    ...
    <link rel="icon" href="asset/image2/LOGO.png">
</head>
...
<body>
                        ...
                        <div class="d-flex justify-content-center align-items-center" style="height: 100%;">
                            <div class="row justify-content-center align-items-center">
                                <div class="col-md-4 text-center mb-4 mb-md-0">
                                    <img src="asset/image2/mobile-marketing-animate.svg" class="img-fluid"
    ...
    <section id="section-2" class="container-fluid">
        <div class="container">
            ...
            <div class="d-flex justify-content-center">
                <img src="asset/image2/Mockup-QuotesBuddy2.0-1.png" class="img-fluid mb-5"
    ...
    <section id="section-4" class="container-fluid">
        <div class="container">
            <div class="text-center">
                ...
                <img src="asset/image2/questions-animate.svg" class="img-fluid mb-5"
                ...
                <div class="card shadow card-custom-section4 mb-5" style="width: 1200px;">
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-center align-items-center" style="height: 100%;">
                            <div class="row justify-content-center align-items-center">
                                <div class="col-md-4 text-center mb-4 mb-md-0">
                                    <img src="asset/image2/social-media-animate.svg" class="img-fluid"
                        ...
                        <div class="d-flex justify-content-center align-items-center" style="height: 100%;">
                            <div class="row justify-content-center align-items-center">
                                <div class="col-md-4 text-center mb-4 order-md-1">
                                    <img src="asset/image2/example-animate.svg" class="img-fluid"
                                        style="width: 300px; height: auto;" />
                                </div>
                ...
                <div class="card shadow card-custom-section4 mb-5" style="width: 1200px;">
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-center align-items-center" style="height: 100%;">
                            <div class="row justify-content-center align-items-center">
                                <div class="col-md-4 text-center mb-4 mb-md-0">
                                    <img src="asset/image2/upload-animate.svg" class="img-fluid"
                                        style="width: 300px; height: auto;" />
                                </div>
                                <div class="col text-center text-md-start desc" style="padding-right: 50px;">
            ...
            <div class="container">
                <div class="text-center">
                    ...
                    <img src="asset/image2/son.png" class="img-fluid" style="max-width: 100%;" />
                </div>
            </div>
        ...
        <div class="container">
                    ...
                    <div class="card-body">
                        <div class="row justify-content-center">
                            <div class="col-md-6 custom-col" style="margin-right: -4px;">
                                <img src="asset/image2/feed-ig/Education-Quotes-Square-1-1.png" class="img-fluid"
                                    alt="Image 1" />
                            </div>
                            <div class="col-md-6 custom-col mb-4" style="margin-left: -4px;">
                                <img src="asset/image2/feed-ig/Education-Quotes-Square-2-1.webp" class="img-fluid"
                                    alt="Image 2" />
                            </div>
                        </div>
            ...
            <div class="card shadow card-col mb-4">
                ...
                <div class="card-body">
                    <div class="row justify-content-center">
                        <div class="col-md-6 custom-col" style="margin-right: -4px;">
                            <img src="asset/image2/story-ig/Education-Quotes-vertical-1.webp" class="img-fluid" width:
                                600px; />
                        </div>
                        <div class="col-md-6 custom-col mb-4" style="margin-left: -4px;">
                            <img src="asset/image2/story-ig/Education-Quotes-vertical-2.webp" class="img-fluid" width:
                                600px; />
                        </div>
                    </div>
                    <div class="text-center mb-4">
            ...
            <div class="d-flex justify-content-center">
                <div class="card shadow card-custom-section7">
                    <div class="card-body text-center">
                        ...
                        <img src="asset/image2/discount-animate.svg" class="img-fluid" width="500px" />
                        ...
                        <a href="{{ route('landing.salespage.index') }}" class="custom-href">
    ...
    <section id="section-8" class="container-fluid">
        <div class="container">
            <div class="text-center">
                <img src="asset/image2/LOGO.png" width="160px" class="img-fluid mb-4" /><br>
